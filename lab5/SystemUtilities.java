...
public class SystemUtilities {
    ...
    // Metoda pentru citirea jurnalului de sistem Windows
    ...
    // Metoda pentru curățarea fișierelor vechi
    public static void cleanupOldFiles() {
        ...
        // Comparatorul corectat (fără erori)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Utilitare de Sistem ===");
        System.out.println("1. Citeste jurnalul de sistem Windows");
        System.out.println("2. Curata fisiere vechi");
        System.out.print("Alege optiunea (1 sau 2): ");
